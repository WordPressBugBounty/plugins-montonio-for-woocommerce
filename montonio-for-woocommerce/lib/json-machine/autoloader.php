 ...
 *
 * To use this just include this file in your script and the MontonioJsonMachine namespace will be made available
 *
...
// Vendored copy: composer.json is not shipped, so load the helper functions
// directly. Upstream lists src/functions.php in composer.autoload.files.
