...
use MontonioJsonMachine\Exception\InvalidArgumentException;
use MontonioJsonMachine\Exception\MontonioJsonMachineException;
use MontonioJsonMachine\Exception\PathNotFoundException;
use MontonioJsonMachine\Exception\SyntaxErrorException;
use MontonioJsonMachine\Exception\UnexpectedEndSyntaxErrorException;
use MontonioJsonMachine\JsonDecoder\ExtJsonDecoder;
use MontonioJsonMachine\JsonDecoder\ItemDecoder;
use MontonioJsonMachine\JsonDecoder\StringOnlyDecoder;
use LogicException;
use Traversable;
...
class Parser implements \IteratorAggregate, PositionAware
{
    ...
    /**
     * @throws MontonioJsonMachineException
     */
    public function getCurrentJsonPointer(): string
    {
        if ($this->currentPath === null) {
            throw new MontonioJsonMachineException(__METHOD__.' must be called inside a loop');
        }
