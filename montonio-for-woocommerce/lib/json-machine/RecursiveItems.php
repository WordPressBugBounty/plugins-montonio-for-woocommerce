...
final class RecursiveItems implements \RecursiveIterator, PositionAware, \ArrayAccess
{
    ...
    {
        $this->parserIterator = montonio_json_machine_to_iterator($this->parser->getIterator());
    ...
    public function toArray(): array
    {
        try {
            ...
            if (false !== strpos($e->getMessage(), 'generator')) {
                throw new MontonioJsonMachineException(
    ...
    public function offsetExists($offset): bool
    {
        try {
            ...
            return true;
        } catch (MontonioJsonMachineException $e) {
            return false;
        }
    }
