                            ...
                            <tr<?php echo ! empty( $classes ) ? ' class="' . esc_attr( implode( ' ', $classes ) ) . '"' : ''; ?>>
                                <?php if ( 0 === $j ) : ?>
                                    <td rowspan="<?php echo esc_attr( $row_count ); ?>">
                                        ...
                                        <?php if ( $is_existing ) : ?>
                                            <em>(<?php esc_html_e( 'already exists', 'montonio-for-woocommerce' ); ?>)</em>
                                            <br>
                                            <em><?php esc_html_e( 'Modifications will be skipped', 'montonio-for-woocommerce' ); ?></em>
                                        <?php endif; ?>
                                    </td>
                                    <td rowspan="<?php echo esc_attr( $row_count ); ?>">
            ...
            <?php if ( ! empty( $all_skipped ) ) : ?>
                <p>
                    ...
                    printf(
                        ...
                        esc_html__( '%d zones skipped (already exist)', 'montonio-for-woocommerce' ),
                        count( $all_skipped )
                    );
                    ?>
                </p>
