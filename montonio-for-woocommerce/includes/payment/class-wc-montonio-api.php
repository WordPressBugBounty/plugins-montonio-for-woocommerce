...
class WC_Montonio_API {
    ...
    protected function build_order_data( $order, $payment_data ) {
        ...
        $order_data = array(
            ...
            'notificationUrl'          => (string) apply_filters( 'wc_montonio_notification_url', add_query_arg( 'wc-api', 'montonio_notification', trailingslashit( get_home_url() ) ), $payment_method_id ),
            'returnUrl'                => (string) apply_filters( 'wc_montonio_return_url', add_query_arg( 'wc-api', 'montonio_return', trailingslashit( get_home_url() ) ), $payment_method_id ),
